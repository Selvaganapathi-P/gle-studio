      ...
      <div className="container">
        <div className="footer-grid">
          <div>
            ...
            <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '0.85rem', lineHeight: 1.7, maxWidth: 280 }}>
          ...
          <div>
            ...
            <div style={{ color: 'rgba(255,255,255,0.85)', fontSize: '0.85rem', lineHeight: 2 }}>
              <a
                href="https://maps.app.goo.gl/E5GxpuczcpBS5dyP7"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: 'rgba(255,255,255,0.85)', display: 'block', cursor: 'pointer', textDecoration: 'underline', textDecorationStyle: 'dotted', textUnderlineOffset: '3px', lineHeight: 1.6, marginBottom: '0.3rem' }}
              >
                📍 Golden legacy events, Periyagaram,<br />Tirupattur 635901
              </a>
              <div>📞 +91 6382748663</div>
              <div>✉️ tirupattur.gle2024@gmail.com</div>
